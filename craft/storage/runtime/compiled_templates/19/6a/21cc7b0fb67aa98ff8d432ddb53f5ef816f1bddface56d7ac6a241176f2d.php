...
class __TwigTemplate_196a21cc7b0fb67aa98ff8d432ddb53f5ef816f1bddface56d7ac6a241176f2d extends Craft\BaseTemplate
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (((!array_key_exists("field", $context)) && array_key_exists("fieldId", $context))) {
            // line 8
            $context["field"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "fields"), "getFieldById", array(0 => (isset($context["fieldId"]) ? $context["fieldId"] : $this->getContext($context, "fieldId"))), "method");
            // line 9
        ...
        // line 15
        $context["groups"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "fields"), "getAllGroups", array(0 => "id"), "method");
        // line 16
        ...
        // line 20
        $context["groupId"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "request"), "getQuery", array(0 => "groupId"), "method");
        // line 22
        if ((!(isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId")))) {
            // line 23
            if (array_key_exists("field", $context)) {
                // line 24
                $context["groupId"] = $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "groupId");
            } else {
                // line 26
                $context["groupId"] = $this->getAttribute(twig_get_array_keys_filter((isset($context["groups"]) ? $context["groups"] : $this->getContext($context, "groups"))), 0, array(), "array");
            }
        }
        // line 30
        if ((!$this->getAttribute((isset($context["groups"]) ? $context["groups"] : null), (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId")), array(), "array", true, true))) {
            // line 31
            throw new \Craft\HttpException(404);
        }
        // line 35
        $context["crumbs"] = array(0 => array("label" => \Craft\Craft::t("Settings"), "url" => \Craft\UrlHelper::getUrl("settings")), 1 => array("label" => \Craft\Craft::t("Fields"), "url" => \Craft\UrlHelper::getUrl("settings/fields")), 2 => array("label" => $this->getAttribute($this->getAttribute((isset($context["groups"]) ? $context["groups"] : $this->getContext($context, "groups")), (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId")), array(), "array"), "name"), "url" => \Craft\UrlHelper::getUrl(("settings/fields/" . (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId"))))));
        // line 41
        if (array_key_exists("fieldId", $context)) {
            // line 42
            $context["title"] = $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "name");
        } else {
            // line 44
            $context["title"] = \Craft\Craft::t("Create a new field");
        }
        // line 48
        $context["fieldTypes"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "fields"), "getAllFieldTypes", array(), "method");
        // line 50
        if (array_key_exists("field", $context)) {
            // line 51
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 72
            echo "\t\t\t";
            $context["groupOptions"] = twig_array_merge((isset($context["groupOptions"]) ? $context["groupOptions"] : $this->getContext($context, "groupOptions")), array(0 => array("label" => $this->getAttribute((isset($context["group"]) ? $context["group"] : $this->getContext($context, "group")), "name"), "value" => $this->getAttribute((isset($context["group"]) ? $context["group"] : $this->getContext($context, "group")), "id"))));
            // line 73
            echo "\t\t";
        }
        ...
        // line 74
        echo "\t\t";
        echo $context["forms"]->getselectField(array("first" => true, "label" => \Craft\Craft::t("Group"), "instructions" => \Craft\Craft::t("Which group should this field be displayed in?"), "id" => "group", "name" => "group", "options" => (isset($context["groupOptions"]) ? $context["groupOptions"] : $this->getContext($context, "groupOptions")), "value" => (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId"))));
        // line 82
        echo "
...
\t\t";
        // line 96
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Handle"), "instructions" => \Craft\Craft::t("How you’ll refer to this field in the templates."), "id" => "handle", "class" => "code", "name" => "handle", "maxlength" => 64, "value" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "handle")) : (null)), "errors" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "getErrors", array(0 => "handle"), "method")) : (null)), "required" => true));
        // line 106
        echo "

\t\t";
        // line 108
        echo $context["forms"]->gettextareaField(array("label" => \Craft\Craft::t("Instructions"), "instructions" => \Craft\Craft::t("Helper text to guide the author."), "id" => "instructions", "class" => "nicetext", "name" => "instructions", "value" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "instructions")) : (null)), "errors" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "getErrors", array(0 => "instructions"), "method")) : (null)), "translatable" => true));
        // line 117
        echo "
...
\t\t";
        // line 129
        echo $context["forms"]->getselectField(array("label" => \Craft\Craft::t("Field Type"), "instructions" => (\Craft\Craft::t("What type of field is this?") . ((array_key_exists("fieldId", $context)) ? ((("<br><span class=\"error\">" . \Craft\Craft::t("Careful—changing this may result in data loss.")) . "</span>")) : (""))), "id" => "type", "name" => "type", "options" => (isset($context["fieldTypes"]) ? $context["fieldTypes"] : $this->getContext($context, "fieldTypes")), "value" => $this->getAttribute((isset($context["fieldType"]) ? $context["fieldType"] : $this->getContext($context, "fieldType")), "getClassHandle", array(), "method"), "errors" => (((isset($context["isFieldTypeMissing"]) ? $context["isFieldTypeMissing"] : $this->getContext($context, "isFieldTypeMissing"))) ? (array(0 => \Craft\Craft::t("The fieldtype class “{class}” could not be found.", array("class" => $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "type"))))) : (null)), "toggle" => true));
        // line 138
        echo "
