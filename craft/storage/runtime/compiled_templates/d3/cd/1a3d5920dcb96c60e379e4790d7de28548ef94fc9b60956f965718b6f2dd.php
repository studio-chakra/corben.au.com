...
class __TwigTemplate_d3cd1a3d5920dcb96c60e379e4790d7de28548ef94fc9b60956f965718b6f2dd extends Craft\BaseTemplate
{
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["source"]) {
                ...
                echo "\" data-name=\"";
                echo twig_escape_filter($this->env, \Craft\Craft::t($this->getAttribute((isset($context["source"]) ? $context["source"] : $this->getContext($context, "source")), "name")), "html", null, true);
                echo "\">
\t\t\t\t\t\t<th scope=\"row\" data-title=\"";
                // line 25
                echo twig_escape_filter($this->env, \Craft\Craft::t("Name"), "html", null, true);
                echo "\"><a href=\"";
                echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl(("settings/assets/sources/" . $this->getAttribute((isset($context["source"]) ? $context["source"] : $this->getContext($context, "source")), "id"))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, \Craft\Craft::t($this->getAttribute((isset($context["source"]) ? $context["source"] : $this->getContext($context, "source")), "name")), "html", null, true);
                echo "</a></th>
\t\t\t\t\t\t";
                ...
                if (((isset($context["CraftEdition"]) ? $context["CraftEdition"] : $this->getContext($context, "CraftEdition")) == (isset($context["CraftPro"]) ? $context["CraftPro"] : $this->getContext($context, "CraftPro")))) {
                    ...
                    echo twig_escape_filter($this->env, \Craft\Craft::t("Type"), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["source"]) ? $context["source"] : $this->getContext($context, "source")), "getSourceType", array(), "method"), "getName", array(), "method"), "html", null, true);
                    echo "</td>";
                }
                // line 27
                echo "\t\t\t\t\t\t";
