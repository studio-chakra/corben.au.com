...
/* _upgrademodal */
class __TwigTemplate_ce9f5c43582fd6a645828b4baab568ac85f75db8493b098b50f27f3658477469 extends Craft\BaseTemplate
{
...
";
        // line 32
        $context["__internal_770b7c8882e310d90878e39f50e954a07f7d6fbea2a32271b74d1739ae38f4bf"] = $this;
        // line 33
...
\t\t\t\t<td>";
        // line 46
        echo $context["__internal_770b7c8882e310d90878e39f50e954a07f7d6fbea2a32271b74d1739ae38f4bf"]->getbuybtn((isset($context["CraftClient"]) ? $context["CraftClient"] : null), $this->getAttribute((isset($context["editions"]) ? $context["editions"] : null), (isset($context["CraftClient"]) ? $context["CraftClient"] : null), array(), "array"), (isset($context["licensedEdition"]) ? $context["licensedEdition"] : null), (isset($context["canTestEditions"]) ? $context["canTestEditions"] : null));
        echo "</td>
\t\t\t\t<td>";
        // line 47
        echo $context["__internal_770b7c8882e310d90878e39f50e954a07f7d6fbea2a32271b74d1739ae38f4bf"]->getbuybtn((isset($context["CraftPro"]) ? $context["CraftPro"] : null), $this->getAttribute((isset($context["editions"]) ? $context["editions"] : null), (isset($context["CraftPro"]) ? $context["CraftPro"] : null), array(), "array"), (isset($context["licensedEdition"]) ? $context["licensedEdition"] : null), (isset($context["canTestEditions"]) ? $context["canTestEditions"] : null));
        echo "</td>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
...
";
    ...
    public function getbuybtn($_edition = null, $_info = null, $_licensedEdition = null, $_canTestEditions = null)
    {
        ...
        try {
            ...
            // line 4
            echo "\t\t";
            if (((isset($context["edition"]) ? $context["edition"] : null) == (isset($context["CraftEdition"]) ? $context["CraftEdition"] : null))) {
                // line 5
...
\t\t\t";
            // line 10
            echo "\t\t\t";
            if (((isset($context["edition"]) ? $context["edition"] : null) > (isset($context["licensedEdition"]) ? $context["licensedEdition"] : null))) {
                // line 11
                echo "\t\t\t\t<div class=\"btn buybtn\" data-edition=\"";
                echo twig_escape_filter($this->env, (isset($context["edition"]) ? $context["edition"] : null), "html", null, true);
                echo "\">
\t\t\t\t\t";
                // line 12
                if ($this->getAttribute((isset($context["info"]) ? $context["info"] : null), "salePrice")) {
                    // line 13
                    echo "\t\t\t\t\t\t<span class=\"listedprice\">";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["info"]) ? $context["info"] : null), "formattedPrice"), "html", null, true);
                    echo "</span> ";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["info"]) ? $context["info"] : null), "formattedSalePrice"), "html", null, true);
                    echo "
\t\t\t\t\t";
                } else {
                    // line 15
...
\t\t\t";
            // line 21
            echo "\t\t\t";
            if ((isset($context["canTestEditions"]) ? $context["canTestEditions"] : null)) {
                // line 22
                echo "\t\t\t\t";
                if (((isset($context["edition"]) ? $context["edition"] : null) == (isset($context["CraftEdition"]) ? $context["CraftEdition"] : null))) {
                    // line 23
