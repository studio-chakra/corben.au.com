...
class __TwigTemplate_de88936b787f5d1752676743a9df4af3604666f56798822aab9965a50f3fea95 extends Craft\BaseTemplate
{
...
";
        // line 4
        if ((twig_length_filter($this->env, (isset($context["configOptions"]) ? $context["configOptions"] : $this->getContext($context, "configOptions"))) > 1)) {
            // line 5
            echo "\t";
            ob_start();
            // line 6
            echo "\t\t";
            echo $context["forms"]->getselect(array("id" => "configFle", "name" => "configFile", "options" => (isset($context["configOptions"]) ? $context["configOptions"] : $this->getContext($context, "configOptions")), "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "configFile")));
            // line 11
            echo "
\t";
...
";
        // line 26
        echo $context["forms"]->getcheckboxField(array("label" => \Craft\Craft::t("Clean up HTML?"), "instructions" => \Craft\Craft::t("Removes <code>&lt;span&gt;</code>’s, empty tags, and most <code>style</code> attributes on save."), "id" => "cleanupHtml", "name" => "cleanupHtml", "checked" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "cleanupHtml")));
        // line 32
        echo "
";
    }
