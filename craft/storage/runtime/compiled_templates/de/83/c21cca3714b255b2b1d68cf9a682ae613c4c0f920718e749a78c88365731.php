...
class __TwigTemplate_de83c21cca3714b255b2b1d68cf9a682ae613c4c0f920718e749a78c88365731 extends Craft\BaseTemplate
{
    ...
    {
        // line 3
        $context["entryTypes"] = $this->getAttribute((isset($context["section"]) ? $context["section"] : $this->getContext($context, "section")), "getEntryTypes", array(), "method");
        // line 4
        $context["multiple"] = (twig_length_filter($this->env, (isset($context["entryTypes"]) ? $context["entryTypes"] : $this->getContext($context, "entryTypes"))) > 1);
        // line 6
        ob_start();
        // line 7
...
\t\t\t\t\t<th scope=\"row\" data-title=\"";
            ...
            echo twig_escape_filter($this->env, \Craft\Craft::t("Name"), "html", null, true);
            echo "\"><a href=\"";
            echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl(((("settings/sections/" . $this->getAttribute((isset($context["section"]) ? $context["section"] : $this->getContext($context, "section")), "id")) . "/entrytypes/") . $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : $this->getContext($context, "entryType")), "id"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : $this->getContext($context, "entryType")), "name"), "html", null, true);
            echo "</a></th>
\t\t\t\t\t<td data-title=\"";
            ...
            echo twig_escape_filter($this->env, \Craft\Craft::t("Handle"), "html", null, true);
            echo "\"><code>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : $this->getContext($context, "entryType")), "handle"), "html", null, true);
            echo "</code></td>
\t\t\t\t\t";
            // line 21
            if ((isset($context["multiple"]) ? $context["multiple"] : $this->getContext($context, "multiple"))) {
...
\t\t\t<a href=\"";
            // line 32
            echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl((("settings/sections/" . $this->getAttribute((isset($context["section"]) ? $context["section"] : $this->getContext($context, "section")), "id")) . "/entrytypes/new")), "html", null, true);
