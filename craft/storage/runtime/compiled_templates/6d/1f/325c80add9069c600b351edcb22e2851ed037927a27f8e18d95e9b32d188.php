...
class __TwigTemplate_6d1f325c80add9069c600b351edcb22e2851ed037927a27f8e18d95e9b32d188 extends Craft\BaseTemplate
{
...
\t\t\t\t";
            // line 32
            echo $context["forms"]->getselectField(array("label" => \Craft\Craft::t("Type"), "instructions" => \Craft\Craft::t("What type of source is this?"), "id" => "type", "name" => "type", "options" => (isset($context["sourceTypes"]) ? $context["sourceTypes"] : $this->getContext($context, "sourceTypes")), "value" => $this->getAttribute((isset($context["sourceType"]) ? $context["sourceType"] : $this->getContext($context, "sourceType")), "getClassHandle", array(), "method"), "toggle" => true));
            // line 40
            echo "
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["_sourceType"]) {
                // line 43
                echo "\t\t\t\t\t";
                $context["isCurrent"] = ($this->getAttribute((isset($context["_sourceType"]) ? $context["_sourceType"] : $this->getContext($context, "_sourceType")), "getClassHandle", array(), "method") == $this->getAttribute((isset($context["sourceType"]) ? $context["sourceType"] : $this->getContext($context, "sourceType")), "getClassHandle", array(), "method"));
                // line 44
                echo "
\t\t\t\t\t<div id=\"";
                // line 45
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["_sourceType"]) ? $context["_sourceType"] : $this->getContext($context, "_sourceType")), "getClassHandle", array(), "method"), "html", null, true);
                echo "\"";
...
\t\t\t\t\t\t";
                // line 46
                $_namespace = (("types[" . $this->getAttribute((isset($context["_sourceType"]) ? $context["_sourceType"] : $this->getContext($context, "_sourceType")), "getClassHandle", array(), "method")) . "]");
                if ($_namespace) {
                    ...
                    try {
                        ...
                        if ((isset($context["isCurrent"]) ? $context["isCurrent"] : $this->getContext($context, "isCurrent"))) {
                            // line 48
                            echo "\t\t\t\t\t\t\t\t";
                            echo $this->getAttribute((isset($context["sourceType"]) ? $context["sourceType"] : $this->getContext($context, "sourceType")), "getSettingsHtml", array(), "method");
                            echo "
\t\t\t\t\t\t\t";
                        } else {
                            // line 50
                            echo "\t\t\t\t\t\t\t\t";
                            echo $this->getAttribute((isset($context["_sourceType"]) ? $context["_sourceType"] : $this->getContext($context, "_sourceType")), "getSettingsHtml", array(), "method");
                            echo "
\t\t\t\t\t\t\t";
                        }
                        // line 52
...
\t\t\t\t";
            ...
            // line 56
            echo "\t\t\t\t";
            $_namespace = (("types[" . $this->getAttribute((isset($context["sourceType"]) ? $context["sourceType"] : $this->getContext($context, "sourceType")), "getClassHandle", array(), "method")) . "]");
            if ($_namespace) {
                $_originalNamespace = \Craft\craft()->templates->getNamespace();
                \Craft\craft()->templates->setNamespace(\Craft\craft()->templates->namespaceInputName($_namespace));
                ob_start();
...
\t\t\t";
        // line 63
        $this->env->loadTemplate("_includes/fieldlayoutdesigner")->display(array("fieldLayout" => $this->getAttribute((isset($context["source"]) ? $context["source"] : $this->getContext($context, "source")), "getFieldLayout", array(), "method"), "customizableTabs" => false, "tab" => "fieldlayout"));
        // line 68
        echo "\t\t</div>
