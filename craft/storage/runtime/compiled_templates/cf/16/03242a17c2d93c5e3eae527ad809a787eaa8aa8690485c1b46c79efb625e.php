...
class __TwigTemplate_cf1603242a17c2d93c5e3eae527ad809a787eaa8aa8690485c1b46c79efb625e extends Craft\BaseTemplate
{
...
";
        // line 30
        echo $context["forms"]->getcheckboxField(array("label" => \Craft\Craft::t("Restrict uploads to a single folder?"), "id" => "useSingleFolder-toggle", "name" => "useSingleFolder", "class" => "use-single-folder-cb", "value" => 1, "checked" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "useSingleFolder"), "toggle" => "single-folder-settings", "reverseToggle" => "multi-folder-settings"));
        // line 39
        echo "

<div id=\"multi-folder-settings\"";
        // line 41
        if ($this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "useSingleFolder")) {
            echo " class=\"hidden\"";
        }
        echo ">
\t";
        // line 42
        if ((isset($context["sourceOptions"]) ? $context["sourceOptions"] : $this->getContext($context, "sourceOptions"))) {
            // line 43
            echo "\t\t";
            echo $context["forms"]->getcheckboxSelectField(array("label" => \Craft\Craft::t("Sources"), "instructions" => \Craft\Craft::t("Which sources do you want to select {type} from?", array("type" => twig_lower_filter($this->env, (isset($context["type"]) ? $context["type"] : $this->getContext($context, "type"))))), "id" => "sources", "name" => "sources", "options" => (isset($context["sourceOptions"]) ? $context["sourceOptions"] : $this->getContext($context, "sourceOptions")), "values" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "sources")));
            // line 50
            echo "
\t";
        } else {
...
";
        // line 73
        echo $context["forms"]->getcheckboxField(array("label" => \Craft\Craft::t("Restrict allowed file types?"), "class" => "restrictFiles", "id" => "", "name" => "restrictFiles", "value" => 1, "checked" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "restrictFiles"), "toggle" => "restrict-allowed-types"));
        // line 81
        echo "

<div id=\"restrict-allowed-types\" ";
        // line 83
        if ((!$this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "restrictFiles"))) {
...
\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["fileKindOptions"]) ? $context["fileKindOptions"] : $this->getContext($context, "fileKindOptions")));
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            // line 85
            echo "\t\t";
            echo $context["forms"]->getcheckboxField(array("label" => $this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "label"), "id" => ("allowedKinds-" . $this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "value")), "name" => "allowedKinds[]", "value" => $this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "value"), "checked" => twig_in_filter($this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "value"), $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "allowedKinds"))));
            // line 91
            echo "
\t";
        }
...
";
        // line 95
        echo twig_escape_filter($this->env, (isset($context["targetLocaleField"]) ? $context["targetLocaleField"] : $this->getContext($context, "targetLocaleField")), "html", null, true);
        echo "

";
        // line 97
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Limit"), "instructions" => \Craft\Craft::t("Limit the number of selectable {type}.", array("type" => twig_lower_filter($this->env, (isset($context["type"]) ? $context["type"] : $this->getContext($context, "type"))))), "id" => "limit", "name" => "limit", "value" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "limit"), "size" => 2, "errors" => $this->getAttribute((isset($context["settings"]) ? $context["settings"] : $this->getContext($context, "settings")), "getErrors", array(0 => "limit"), "method")));
        // line 105
        echo "
";
    }
