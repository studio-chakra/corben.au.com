...
class __TwigTemplate_2d2c5a94b6f64b77cf49b2dd3c3290ec6c256179fa26e4a7e5705ea130ce19b7 extends Craft\BaseTemplate
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        if (((!(isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs"))) && (!array_key_exists("pretendTabName", $context)))) {
            // line 3
            echo "\t";
...
";
        ...
        // line 7
        $context["fields"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "fields"), "getAllFields", array(0 => "id"), "method");
        // line 8
        echo "
";
        // line 9
...
\t\t";
        // line 50
        if ((isset($context["fieldLayout"]) ? $context["fieldLayout"] : $this->getContext($context, "fieldLayout"))) {
            // line 51
            echo "\t\t\t";
            $context["macros"] = $this;
            // line 52
...
\t\t\t";
            // line 53
            if ((isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs"))) {
                // line 54
                echo "\t\t\t\t";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["fieldLayout"]) ? $context["fieldLayout"] : $this->getContext($context, "fieldLayout")), "getTabs", array(), "method"));
                foreach ($context['_seq'] as $context["_key"] => $context["tab"]) {
                    // line 55
                    echo "\t\t\t\t\t";
                    echo $context["macros"]->gettab((isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs")), $this->getAttribute((isset($context["tab"]) ? $context["tab"] : $this->getContext($context, "tab")), "name"), $this->getAttribute((isset($context["tab"]) ? $context["tab"] : $this->getContext($context, "tab")), "getFields", array(), "method"));
                    echo "
\t\t\t\t";
                }
                ...
                // line 58
                echo "\t\t\t\t";
                echo $context["macros"]->gettab((isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs")), (isset($context["pretendTabName"]) ? $context["pretendTabName"] : $this->getContext($context, "pretendTabName")), $this->getAttribute((isset($context["fieldLayout"]) ? $context["fieldLayout"] : $this->getContext($context, "fieldLayout")), "getFields", array(), "method"));
                echo "
\t\t\t";
            }
            // line 60
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            echo "\t\t\t";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["group"]) ? $context["group"] : $this->getContext($context, "group")), "fields"));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 74
                echo "\t\t\t\t";
                if (((!(isset($context["fieldLayout"]) ? $context["fieldLayout"] : $this->getContext($context, "fieldLayout"))) || !twig_in_filter($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "id"), $this->getAttribute((isset($context["fieldLayout"]) ? $context["fieldLayout"] : $this->getContext($context, "fieldLayout")), "getFieldIds", array(), "method")))) {
                    // line 75
                    echo "\t\t\t\t\t";
                    $context["totalUnselected"] = ((isset($context["totalUnselected"]) ? $context["totalUnselected"] : $this->getContext($context, "totalUnselected")) + 1);
                    // line 76
                    echo "\t\t\t\t";
                }
                // line 77
...
\t\t\t<div class=\"fld-tab unused";
            // line 79
            if (((isset($context["totalUnselected"]) ? $context["totalUnselected"] : $this->getContext($context, "totalUnselected")) == 0)) {
                echo " hidden";
            }
            echo "\">
\t\t\t\t<div class=\"tabs\">
...
\t\t\tcustomizableTabs: ";
        // line 100
        echo (((isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs"))) ? ("true") : ("false"));
        echo "
\t\t});
\t};
...
\t\tvar \$fldTab = \$('#tab-";
            // line 106
            echo twig_escape_filter($this->env, (isset($context["tab"]) ? $context["tab"] : $this->getContext($context, "tab")), "html", null, true);
            echo "');
...
\t\t\t\t<span>";
            // line 24
            echo twig_escape_filter($this->env, (isset($context["tabName"]) ? $context["tabName"] : $this->getContext($context, "tabName")), "html", null, true);
            echo "</span>
\t\t\t\t";
            // line 25
            if ((isset($context["customizableTabs"]) ? $context["customizableTabs"] : $this->getContext($context, "customizableTabs"))) {
...
\t\t\t";
            // line 31
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["tabFields"]) ? $context["tabFields"] : $this->getContext($context, "tabFields")));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 32
                ...
                echo "\" data-id=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "fieldId"), "html", null, true);
                echo "\">
...
\t\t\t\t\t<span>";
                // line 34
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "getField", array(), "method"), "name"), "html", null, true);
                echo "</span>
\t\t\t\t\t<input class=\"id-input\" type=\"hidden\" name=\"fieldLayout[";
                // line 35
                echo twig_escape_filter($this->env, twig_escape_filter($this->env, (isset($context["tabName"]) ? $context["tabName"] : $this->getContext($context, "tabName")), "url"), "html", null, true);
                echo "][]\" value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "fieldId"), "html", null, true);
                echo "\">
\t\t\t\t\t";
