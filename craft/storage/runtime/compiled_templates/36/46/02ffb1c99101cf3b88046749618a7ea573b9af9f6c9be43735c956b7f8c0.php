...
/* settings/fields */
class __TwigTemplate_364602ffb1c99101cf3b88046749618a7ea573b9af9f6c9be43735c956b7f8c0 extends Craft\BaseTemplate
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (array_key_exists("groupId", $context)) {
            ...
            // line 29
            $context["fields"] = $this->getAttribute($this->getAttribute((isset($context["groups"]) ? $context["groups"] : $this->getContext($context, "groups")), (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId")), array(), "array"), "getFields", array(), "method");
        } else {
            // line 31
            $context["fields"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : $this->getContext($context, "craft")), "fields"), "getAllFields", array(), "method");
        }
        // line 35
        ob_start();
        // line 36
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 41
            echo "\t\t\t\t<li><a href=\"";
            echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl(("settings/fields/" . $this->getAttribute((isset($context["group"]) ? $context["group"] : $this->getContext($context, "group")), "id"))), "html", null, true);
            echo "\"";
            if ((array_key_exists("groupId", $context) && ($this->getAttribute((isset($context["group"]) ? $context["group"] : $this->getContext($context, "group")), "id") == (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId"))))) {
                echo " class=\"sel\"";
            }
            echo " data-id=\"";
...
\t\t\t\t\t\t<th scope=\"row\" data-title=\"";
                ...
                echo twig_escape_filter($this->env, \Craft\Craft::t("Name"), "html", null, true);
                echo "\"><a href=\"";
                echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl(("settings/fields/edit/" . $this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "id"))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, \Craft\Craft::t($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "name")), "html", null, true);
                echo "</a>";
                // line 85
...
\t\t\t\t\t\t\t";
                ...
                if ((isset($context["fieldType"]) ? $context["fieldType"] : $this->getContext($context, "fieldType"))) {
                    // line 91
                    echo "\t\t\t\t\t\t\t\t";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["fieldType"]) ? $context["fieldType"] : $this->getContext($context, "fieldType")), "name"), "html", null, true);
                    echo "
\t\t\t\t\t\t\t";
                } else {
                    // line 93
...
\t\t\t\t\t\t";
                ...
                if ((!array_key_exists("groupId", $context))) {
                    ...
                    echo twig_escape_filter($this->env, \Craft\Craft::t("Group"), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["field"]) ? $context["field"] : $this->getContext($context, "field")), "group"), "name"), "html", null, true);
                    echo "</td>";
                }
                // line 97
...
\t\t\t";
            // line 106
            $context["newFieldUrl"] = \Craft\UrlHelper::getUrl("settings/fields/new", ((array_key_exists("groupId", $context)) ? (array("groupId" => (isset($context["groupId"]) ? $context["groupId"] : $this->getContext($context, "groupId")))) : (null)));
            // line 107
            echo "\t\t\t<a href=\"";
            echo twig_escape_filter($this->env, (isset($context["newFieldUrl"]) ? $context["newFieldUrl"] : $this->getContext($context, "newFieldUrl")), "html", null, true);
